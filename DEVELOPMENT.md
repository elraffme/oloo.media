...
```bash
git remote add encore encore://github-project-import-qkvi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/github-project-import-qkvi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/github-project-import-qkvi/settings/integrations/github)
